...
namespace saastemplate.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update saastemplateDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update saastemplateEfCoreEntityExtensionMappings to extend the IdentityUser entity
